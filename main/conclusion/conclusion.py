...
from selenium.webdriver.common.devtools.v145.debugger import resume

from parser import parse_conclusion
...
def gen_conclu():
    ...
    for chapitre in chapitres:
        for section in chapitre["sections"]:
            coherence_path = os.path.join("..", "resume", f"coherence_ch{chapitre['numero']}_s{section['numero']}.json")
    ...
    filepath = os.path.join("output", "conclusion.json")
