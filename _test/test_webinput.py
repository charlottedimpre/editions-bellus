...
def webinputresponse():
    ...
    sujet_path = os.path.join("output", "demo", "fiche_cadrage.json")
    with open(sujet_path, "r", encoding="utf-8") as f:
        sujet = f.read()

    input_path = os.path.join("input", "web_search", "ws_search.txt")
...
if __name__ == '__main__':
    filepath = os.path.join("output", "web_search", "ws_search.json")
